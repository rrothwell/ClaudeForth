...
\ M18 snapshots the dictionary/HERE state right before this
\ file's own definitions begin. Invoking M18 at the end (below)
\ erases everything this file defined - including M18 itself -
