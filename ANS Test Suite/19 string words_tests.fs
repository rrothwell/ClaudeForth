...
\ M19 snapshots the dictionary/HERE state right before this
\ file's own definitions begin. Invoking M19 at the end (below)
\ erases everything this file defined - including M19 itself -
