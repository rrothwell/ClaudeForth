...
\ M17 snapshots the dictionary/HERE state right before this
\ file's own definitions begin. Invoking M17 at the end (below)
\ erases everything this file defined - including M17 itself -
