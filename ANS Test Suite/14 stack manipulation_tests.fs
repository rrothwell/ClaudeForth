...
\ M14 snapshots the dictionary/HERE state right before this
\ file's own definitions begin. Invoking M14 at the end (below)
\ erases everything this file defined - including M14 itself -
