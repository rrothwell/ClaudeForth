...
\ M15 snapshots the dictionary/HERE state right before this
\ file's own definitions begin. Invoking M15 at the end (below)
\ erases everything this file defined - including M15 itself -
