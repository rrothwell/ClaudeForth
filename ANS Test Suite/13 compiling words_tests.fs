...
\ M13 snapshots the dictionary/HERE state right before this
\ file's own definitions begin. Invoking M13 at the end (below)
\ erases everything this file defined - including M13 itself -
