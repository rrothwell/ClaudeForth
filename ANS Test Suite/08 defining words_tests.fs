...
\ M08 snapshots the dictionary/HERE state right before this
\ file's own definitions begin. Invoking M08 at the end (below)
\ erases everything this file defined - including M08 itself -
