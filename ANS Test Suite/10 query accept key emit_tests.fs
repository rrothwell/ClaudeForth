...
\ M10 snapshots the dictionary/HERE state right before this
\ file's own definitions begin. Invoking M10 at the end (below)
\ erases everything this file defined - including M10 itself -
