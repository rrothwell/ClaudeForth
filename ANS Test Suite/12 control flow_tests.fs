...
\ M12 snapshots the dictionary/HERE state right before this
\ file's own definitions begin. Invoking M12 at the end (below)
\ erases everything this file defined - including M12 itself -
