...
\ M16 snapshots the dictionary/HERE state right before this
\ file's own definitions begin. Invoking M16 at the end (below)
\ erases everything this file defined - including M16 itself -
