...
|:------------|:-----------------|:--------------|:------------------|----------:|
| **Conditionals & Loops** |        |      |                       ||
| IF   | H_IF | 0(0) |`ok : ify 6 0> IF ." 6 gt 0." ;`<br />`ERROR -22`|:white_check_mark:|
...
| DO I LEAVE LOOP   | DO IWORD LEAVE LOOP| 0(0) |`: lpy 0 DO I DUP . 2 > IF LEAVE THEN LOOP ; `<br />`ok3 lpy 0 1 2`<br />`ok4 lpy 0 1 2 3`<br />`ok5 lpy 0 1 2 3`<br />`ok`|:white_check_mark:[2]|
